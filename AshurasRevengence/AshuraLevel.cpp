...
/*
void AshuraLevel::RenderTile(TileType tileID, int* randomRow, int* randomCol, int rotationCount=0)
{
...
std::pair<int, int> AshuraLevel::FindLowestEntropy()
{
...
void AshuraLevel::UpdateNeighbourRules(int currentX, int currentY)
{
...
void AshuraLevel::UpdatePossibleTiles(int currentX, int currentY)
{
...
void AshuraLevel::ImplementWFC(TileState(&grid)[20][12])
{
...
void AshuraLevel::RotateTileRules(std::array<int, 3>& upRules, std::array<int, 3>& downRules, std::array<int, 3>& leftRules, std::array<int, 3>& rightRules)
{
