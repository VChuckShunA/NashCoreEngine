...
//	float circleSpeedX = 1.0;//we will use this to move the cirlce later 1.0
//	float circleSpeedY = 0.5; //you will read these values from the file 0.5
...
//		else if (temp == "Circle")
//		{
//			fin >> shapeText >> positionX >> positionY >> speedX >> speedY >> c1 >> c2 >> c3 >> circleRadius;
...
//			customCircle* circle = new customCircle(shapeText, positionX, positionY, speedX, speedY, circleRadius, newColour, fontPath);
...
//		{
//			fin >> shapeText >> positionX >> positionY >> speedX >> speedY >> c1 >> c2 >> c3 >> rectWidth >> rectHeight;
//			float newColour[3] = { c1,c2,c3 };
//			customRectangle* rectangle = new customRectangle(shapeText, positionX, positionY, speedX, speedY, rectWidth, rectHeight, newColour, fontPath);
//			rectangles.push_back(rectangle);
//			allShapes.push_back(rectangle);
//		}
//	}
//
...
//
//		static const char* items[] = { "Apple", "Banana", "Cherry", "Mango" };
//		static int item_current = 0;
//		ImGui::ShowDemoWindow();
//		//draw the UI
//		/*ImGui::Begin("Window title");
//		ImGui::Text("Window text");
//		ImGui::Combo("My Combo", &item_current, items, IM_ARRAYSIZE(items));
